...
public class FileList2Activity extends AppCompatActivity implements ReportContract.ViewMain {
...
//                    } else {
                    ...
                    fn = fn.replace(".html","");
                    myApp.setGlobalString(fn);
                    Intent intent = new Intent(FileList2Activity.this, editActivity.class);
    ...
    private final RecognitionListener listener = new RecognitionListener() {
        ...
        public void onResults(Bundle results) {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                if (s1.equals("삭제")){
                    ...
                    player = MediaPlayer.create(FileList2Activity.this, R.raw.ddok);
                    player.start();
                    Log.d("twice","중복실행");
        ...
        public void file_delete() {
            ...
            try {
                ...
                startActivity(new Intent(FileList2Activity.this, FileList2Activity.class));
                MyApplication myApp = (MyApplication) getApplication();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (currentSelected == position) {
                ...
                if (item != null) {
                    ...
                    //Log.d("startspeak",""+item.getFnData());
                }
            } else {
