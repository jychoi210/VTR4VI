...
public class ReportDetailPresenter implements ReportContract.PresenterDetail {
    ...
    public int getCount(int index) {
        ...
        if (bodyText != null) {
            String[] split = bodyText.trim().split("\\s+");
...
//    @Override
    ...
    ReportDetailPresenter(ReportContract.ViewDetail view) {
        mView = view;
    }
